  ...
  <div class="jumbotron" style="height:20%; background-color: #404040;">
    <div class="slideshow-container">
      <div class="mySlides" style="width:100%">
        <div class="text">
          <h1>Natural Science and Mathematics</h1>
        </div>
      </div>
      ...
      <div class="col-sm-8 text-left" style="background-color: white; padding-top: 20px; padding-bottom: 20px">
        ...
        <table cellpadding="10" style="width:100%; border: 1px solid black;">
          <tr style="border: 1px solid black">
            <th><h3>EVSC 1010: Introduction to Environmental Sciences<br></h3>So easy, but incredibly dull lecturer. Exams are hard if you don’t go to class, but boy does time stop on there<br><br></th>
          </tr>
