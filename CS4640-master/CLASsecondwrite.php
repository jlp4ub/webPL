      ...
      <div class="col-sm-8 text-left" style="background-color: white; padding-top: 20px; padding-bottom: 20px">
        ...
        <table cellpadding="10" style="width:100%; border: 1px solid black;">
          <tr style="border: 1px solid black">
            <th><h3>WGS 4700: Men and Masculinities<br></h3>Hands down one of my favorite classes I've ever taken at UVA. Lisa is the most down to earth and casual professor I have ever had. She knows so much about her field and always brings great energy to class.<br><br></th>
          </tr>
